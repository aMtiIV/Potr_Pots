...
function calculateClientWidth() {
    document.documentElement.style.setProperty("--cw", document.documentElement.clientWidth + "px");
}
...
circleButtons.forEach((circleButton)=>{
    circleButton.addEventListener("click", function() {
        ...
        if (activeCircleButton !== null) toggleActive(activeCircleButton);
        if (circleButton !== activeCircleButton) toggleActive(circleButton);
    });
});
